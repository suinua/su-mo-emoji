...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    main: [function() {
      var t1, t2;
      t1 = document;
      t2 = J.get$onInput$x(t1.getElementById("emoji_1"));
      W._EventStreamSubscription$(t2._html$_target, t2._eventType, F.main__inputEmojiAction$closure(), false, H.getTypeArgumentByIndex(t2, 0));
      t2 = J.get$onInput$x(t1.getElementById("emoji_2"));
      W._EventStreamSubscription$(t2._html$_target, t2._eventType, F.main__inputEmojiAction$closure(), false, H.getTypeArgumentByIndex(t2, 0));
      t2 = J.get$onInput$x(t1.getElementById("suumoTextBox"));
      W._EventStreamSubscription$(t2._html$_target, t2._eventType, F.main__inputTextAction$closure(), false, H.getTypeArgumentByIndex(t2, 0));
      t2 = J.get$onChange$x(t1.getElementById("typeSelect"));
      W._EventStreamSubscription$(t2._html$_target, t2._eventType, F.main__changedType$closure(), false, H.getTypeArgumentByIndex(t2, 0));
      t1 = J.get$onChange$x(t1.getElementById("fontType"));
      W._EventStreamSubscription$(t1._html$_target, t1._eventType, new F.main_closure(), false, H.getTypeArgumentByIndex(t1, 0));
    }, "call$0", "main__main$closure", 0, 0, 0],
    inputEmojiAction: [function($event) {
      var t1, eyeEmoji, bodyEmoji, t2;
      t1 = document;
      eyeEmoji = J.get$value$x(t1.getElementById("emoji_1"));
      bodyEmoji = J.get$value$x(t1.getElementById("emoji_2"));
      t1 = t1.getElementById("resultText");
      t2 = $.suumo;
      H.checkString(eyeEmoji);
      t2 = H.stringReplaceAllUnchecked(t2, "\ud83d\udc41", eyeEmoji);
      H.checkString(bodyEmoji);
      t2 = H.stringReplaceAllUnchecked(H.stringReplaceAllUnchecked(H.stringReplaceAllUnchecked(t2, "\ud83c\udf33", bodyEmoji), " ", "&nbsp;"), "end", "<br>");
      J.setInnerHtml$1$x(t1, t2);
    }, "call$1", "main__inputEmojiAction$closure", 2, 0, 4],
    inputTextAction: [function($event) {
      var t1 = document;
      J.setInnerHtml$1$x(t1.getElementById("resultText"), F.textSuumoGenerator(J.get$value$x(t1.getElementById("suumoTextBox")), false));
    }, "call$1", "main__inputTextAction$closure", 2, 0, 4],
    changedType: [function($event) {
      var t1, t2;
      t1 = document;
      J.setInnerHtml$1$x(t1.getElementById("resultText"), H.stringReplaceAllUnchecked(H.stringReplaceAllUnchecked($.suumo, " ", "&nbsp;"), "end", "<br>"));
      t2 = t1.getElementById("emojiSelect").style;
      t2.display = "none";
      t2 = t1.getElementById("textSelect").style;
      t2.display = "none";
      t1 = t1.getElementById(J.$eq$(J.get$value$x(J.get$target$x($event)), "emoji") ? "emojiSelect" : "textSelect").style;
      t1.display = "";
    }, "call$1", "main__changedType$closure", 2, 0, 4],
    textSuumoGenerator: function(text, innerTextArea) {
      var resultText, t1, i, t2;
      resultText = H.stringReplaceAllUnchecked(H.stringReplaceAllUnchecked($.suumo, " ", "&nbsp;"), "end", "<br>");
      if (J.get$value$x(document.getElementById("fontType")) === "\u5168\u89d2")
        for (t1 = J.getInterceptor$asx(text), i = 0; i <= t1.get$length(text) - 1; ++i) {
          if (i >= text.length)
            return H.ioore(text, i);
          t2 = text[i] + "&nbsp;";
          resultText = H.stringReplaceFirstUnchecked(resultText, "\ud83c\udf33", t2, 0);
        }
      else
        for (t1 = J.getInterceptor$asx(text), i = 0; i <= t1.get$length(text) - 1; ++i) {
          t2 = text.length;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [W.Event]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, v: true, args: [W.Node, W.Node]}];
